...
const Header = () => {
  return (
   <div className='w-full bg-[#EFEFEF] md:px-2'>
     ...
     <div className='flex mt-3 md:my-[30px] max-w-7xl mx-auto justify-center md:justify-between p-3 md:p-0 flex-col md:flex-row md:items-center'>
      <div className='w-full md:w-1/2 flex flex-col justify-center md:mr-5'>
        ...
        <p className='text-[#475467] mt-2 text-sm md:text-base leading-6'>Kelola operasional Money Changer anda menggunakan solusi lengkap dalam meningkatkan pelayanan menjadi lebih cepat dan modern</p>
        <div className='flex mt-5 items-center space-x-3'>
          <Button className={`bg-primary text-white font-semibold text-sm`}>Coba Gratis 30 Hari</Button>
          <Button className={`bg-white border border-[#EAECF0] text-primary font-semibold text-sm`}>Jadwalkan Demo</Button>
        </div>
      </div>
