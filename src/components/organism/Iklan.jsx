...
const DetailIklan = (props) => {
  ...
  return (
    <div className="flex gap-6 p-6 border border-[#EAECF0] rounded-xl">
      <div>
        <div className="bg-primary w-9 md:w-[48px] h-9 md:h-[48px] flex justify-center rounded-full items-center text-[#fff] text-[22px]">
          {no}
        </div>
      </div>
      <div>
        <p className="text-[#1D2939] text-lg md:text-[28px] font-semibold">
          {title}
        </p>
        <p className="text-[#667085] text-sm md:text-base tracking-[0.032px] leading-6 max-w-[471px] md:mt-4">
          {text}
        </p>
      </div>
    </div>
