...
const Colab = () => {
    ...
    return (
        <div className='my-8 px-4 lg:my-16'>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center mt-8 space-x-8 lg:space-x-16">
                {collabImages.map((image, index) => (
                    <img key={index} src={image} alt={`Colab ${index + 1}`} className="w-32 h-32 mb-4 lg:mb-0" />
                ))}
            </div>
