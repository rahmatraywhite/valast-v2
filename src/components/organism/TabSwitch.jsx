      ...
      <div className='flex justify-between items-center mt-8 gap-[38px] flex-wrap'>
        <div className='flex gap-[18px]'>
          <div className='relative'>
            <div className='h-[320px] rounded-3xl bg-[#F2F4F7] w-3'>
              <div
                ...
                style={{ height: `${percentage}%`, transition: 'height 0.3s' }}
              ></div>
            </div>
          </div>
          <div className='flex-col space-y-4'>
            ...
            >
              <img src={Icon1} alt='' />
              <p className='text-[#1D2939] font-semibold text-base lg:text-[24px]'>Analisa Perkembangan Bisnismu</p>
            </div>
            <div
              className='flex items-center border border-[#EAECF0] p-6 rounded-xl cursor-pointer space-x-4'
            ...
            >
              <img src={Icon2} alt='' />
              <p className='text-[#1D2939] font-semibold text-base lg:text-[24px]'>Kenali Pelangganmu</p>
            </div>
            <div
              className='flex items-center border border-[#EAECF0] p-6 rounded-xl cursor-pointer space-x-4'
